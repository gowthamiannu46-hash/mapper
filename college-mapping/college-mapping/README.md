# College Campus Mapping

An interactive GIS mapping project for a college campus in Haryana, India (29.244969°N, 75.781141°E).  
Extracts GPS metadata from geotagged photos and generates Leaflet-based HTML maps, plus a pixel dataset for ML use.
...
```bash
git clone https://github.com/<your-username>/college-mapping.git
cd college-mapping
